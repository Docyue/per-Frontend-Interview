...
---------------------------------------------------------------------------------------------
<font size=5>------数据类型：<a name='h1'></a> </font> 
...
---------------------------------------------------------------------------------------------
<font size=5>------函数，变量，作用域，闭包：<a name='h2'></a></font>
<a name='3'></a>  
...
<font size=1>
	...
	---------------------------------------分割线---------------------------------------
	七、为ES5只有全局作用域和函数作用域，没有块级作用域,ES6新增了块级作用域的概念，let 和 const 是具有块级作用域的绑定用构造，let 是新的 var，只在块级作用域内有效，const也用来声明变量，但是声明的是常量。一旦声明，常量的值就不能改变。（此两种操作符具有静态限制，可以防止出现“在赋值之前使用”的错误。）
</font>
...
---------------------------------------------------------------------------------------------
<font size=5>------事件，事件流，事件机制：<a name='h3'></a></font>  
<a name='5'></a>
**5、说说js中的事件机制？**  
<font size=1>
	...
	四、阻止事件冒泡和阻止事件默认行为
		...
		b.阻止浏览器的默认行为,当按键后,不希望按键继续传递给如HTML文本框对象时,可以取消返回值.即停止事件默认行为;
		//阻止浏览器的默认行为
...
---------------------------------------------------------------------------------------------
<font size=5>------对象，对象继承，原型，原型链：<a name='h4'></a></font>
<a name='7'></a>  
...
---------------------------------------------------------------------------------------------
<font size=5>------http，ajax，跨域，进程，TCP：<a name='h5'></a></font>  
<a name='10'></a>
...
<font size=1>
	...
	3、Ajax的跨域
		...
		E、使用HTML5的window.postMessage方法跨域
			https://segmentfault.com/a/1190000007136269
...
---------------------------------------------------------------------------------------------
<font size=5>------cookie，浏览器本地储存，缓存控制：<a name='h6'></a></font>  
<a name='17'></a>
**17、js操作获取和设置cookie？**  
<font size=1>
...
---------------------------------------------------------------------------------------------
<font size=5>------JS操作（数组，字符串，JSON）：<a name='h7'></a></font>  
<a name='22'></a>
**22、如何给js数组去重？**  
<font size=1>
...
---------------------------------------------------------------------------------------------
<font size=5>------dom操作：<a name='h8'></a></font>  
<a name='24'></a>
...
---------------------------------------------------------------------------------------------
<font size=5>------性能优化：<a name='h9'></a></font>  
<a name='25'></a>
...
---------------------------------------------------------------------------------------------
<font size=5>------模块化：<a name='h10'></a></font>  
<a name='29'></a>
...
---------------------------------------------------------------------------------------------
<font size=5>------框架,其他：<a name='h11'></a></font>  
<a name='30'></a>
**30、iframe的优缺点？**  
<font size=1>
